...
$subtitleData = $editor->getSubtitleData();
$subtitles = \App\Core\Session::get('subtitles', []);
$dictionary = \App\Core\Session::get('dictionary', []);
$fileName = \App\Core\Session::get('file_name', 'Untitled');

// Sync dictionary from file to session if not already loaded
if (empty($dictionary)) {
    $dictModel = new \App\Models\Dictionary();
    $dictionary = $dictModel->all();
    \App\Core\Session::set('dictionary', $dictionary);
}
$styles = \App\Core\Session::get('styles', []);
?>
...
<head>
    ...
    <script src="content/js/SingleEditor.js"></script>
</head>
            ...
            <div class="main-content">
                ...
                <div class="subtitle-list-panel">
                    ...
                    <div class="subtitle-list" id="subtitleList">
                        ...
                        <?php $isAssFormat = !empty($_SESSION['styles']); ?>
                        ...
                        <div class="subtitle-row" data-index="<?= $index ?>">
                            ...
                            <div class="subtitle-text-container">
                                <div class="subtitle-original" data-index="<?= $index ?>"><?= $isAssFormat ? highlightIndonesiaWords($subtitle['text'], $index + 1) : assToHtmlTags(highlightIndonesiaWords(srtTagsToAss($subtitle['text']), $index + 1)) ?></div>
                                <div class="subtitle-modified" data-index="<?= $index ?>"><?= $isAssFormat ? replaceWords(htmlspecialchars($subtitle['text'])) : assToHtmlTags(replaceWords(htmlspecialchars(srtTagsToAss($subtitle['text'])))) ?></div>
                            </div>
