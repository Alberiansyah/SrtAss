...
function handlePostRequest()
{
    ...
    if (isset($_POST['download'])) {
        ...
        if ($format === 'srt') {
            ...
            $scriptInfo = $_SESSION['scriptInfo'] ?? ''; // Ambil Script Info dari session
            $projectGarbage = $_SESSION['projectGarbage'] ?? ''; // Ambil Project Garbage dari session
            $content = convertToAss($subtitles, $styles, $scriptInfo, $projectGarbage); // Panggil convertToAss dengan parameter tambahan
...
function convertToAss($subtitles, $styles = [], $scriptInfo = '', $projectGarbage = '')
{
    $ass = "[Script Info]\n";
    if (!empty($styles)) {
        $ass .= $scriptInfo . "\n"; // Gunakan informasi Script Info dari file asli
    } else {
    ...
    $ass .= $projectGarbage . "\n"; // Gunakan informasi Project Garbage dari file asli
